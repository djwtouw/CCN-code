...
from ._eccn import ccn_logistic, ccs_logistic
from ._stratified_kfold import multilabel_kfold
...
class CCN:
    ...
    def cv(
        ...
        if grid_search_type == "random":
            ...
            raise ValueError("grid_search_type must be 'default' or 'random'")
